    ...
    <div style={{
      ...
      <nav style={{
        ...
        <div style={{ padding: "20px 20px 16px", borderBottom: "1px solid var(--border)" }}>
          <a href="/" style={{ fontSize: 11, fontWeight: 700, color: accent, fontFamily: "var(--mono)", letterSpacing: 2, textTransform: "uppercase", marginBottom: 2, display: "block" }}>\u2190 SOLEDU</a>
